...
public class Test2 extends Application {
	...
	Rectangle backgroundRect = new Rectangle(scene.getWidth(), scene.getHeight(),
	...
	Group blendModeGroup = new Group(new Group(new Rectangle(scene.getWidth(), scene.getHeight(), Color.BLACK), circles), backgroundRect);
	
	backgroundRect.setBlendMode(BlendMode.OVERLAY);
